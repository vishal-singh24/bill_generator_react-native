...
const ForgotPasswordScreen = () => {
    ...
    const validatePassword = (text, field) => {
        if (field == 'password') {
            ...
            if (!regexPassword(text)) {
                setPasswordError('must contain 8 letter and lower,upper and special character');
            } else {
                setPasswordError('');
            }
    ...
    const handleResetPassword = async () => {
        ...
        const storedEmail = await KeyChain.getGenericPassword();
        console.log(storedEmail.username)
        if(email!=storedEmail.user || storedEmail==undefined)
        {
        ...
        try {
            ...
            await KeyChain.setGenericPassword(storedEmail, password)
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.textContainer}>
                <Text style={styles.headingText}>Reset the Password by filling the following details</Text>
        ...
        <Text style={styles.headingText}>Details to Become Member</Text> */}
            ...
            <View style={styles.formContainer}>
                ...
                <View style={styles.inputContainer}>
                    ...
                    <TextInput style={styles.textInput} placeholder='Set your password' placeholderTextColor={colors.secondary}
                ...
                <View style={styles.inputContainer}>
                    <SimpleLineIcons name={"lock"} size={25} color={colors.secondary} />
                    <TextInput style={styles.textInput} placeholder='ReEnter the above password' placeholderTextColor={colors.secondary}
                        secureTextEntry={secureEntry} onChangeText={(text) => {
                            if (text.trim() === '') {
                                setRePasswordError('')
                            }
                ...
                <TouchableOpacity style={styles.loginWrapper} onPress={handleResetPassword}>
